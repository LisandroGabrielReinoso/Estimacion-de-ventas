...
if st.sidebar.button("Entrenar"):
    ...
    st.sidebar.success("Entrenamiento éxitoso.")
    ...
    plt.plot(datos["dia"], predicciones_desnormalizadas, label='Curva de ajustes', linestyle='-', color="red")
    ...
    plt.figure(figsize=(10, 6))
    plt.plot(range(epocas), perdidas, label="Perdida", color="green")
    plt.xlabel("Épocas")
    plt.ylabel("Perdida")
    plt.legend()
